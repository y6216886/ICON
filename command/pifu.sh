...
# CUDA_VISIBLE_DEVICES=3 WANDB__SERVICE_WAIT=300 python -m apps.train -cfg  configs/train/pifu_normal_debug/pifu_img+normb.yaml --gpus 0
# CUDA_VISIBLE_DEVICES=3 WANDB__SERVICE_WAIT=300 python -m apps.train -cfg  configs/train/pifu_normal_debug/pifu_img+normb.yaml -test --gpus 0




# CUDA_VISIBLE_DEVICES=0 WANDB__SERVICE_WAIT=300 python -m apps.train -cfg  configs/train/pifu_normal_debug/pifu_img+normb+normf.yaml --gpus 0
# CUDA_VISIBLE_DEVICES=0 WANDB__SERVICE_WAIT=300 python -m apps.train -cfg  configs/train/pifu_normal_debug/pifu_img+normb+normf.yaml -test --gpus 0

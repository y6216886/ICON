...
CUDA_VISIBLE_DEVICES=4 WANDB__SERVICE_WAIT=300 python -m apps.train -cfg configs/train/icon_study_feature/icon-filter_wovis.yaml  --gpus 0 --num_gpus 1 --mlp_first_dim 13  -test 